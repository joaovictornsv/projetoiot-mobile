    ...
    <View style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center', width: '100%', backgroundColor: '#F9F9F9' }}>
      {isLoading ? <Spinner size="lg" color="#D27842" />  :
        ...
        <View style={{width: '80%', marginTop: 100, marginBottom: 70}}>
          <Text style={{fontWeight: 'bold', fontSize: 36, color: '#0C0F14', marginBottom: 30 }} >Cadastro</Text>
          <ScrollView height='100%'>
            ...
            <View style={{marginTop: 15 , flexDirection:"column", gap: 16, justifyContent: 'space-between', alignItems: 'center',width: '100%'}}>
